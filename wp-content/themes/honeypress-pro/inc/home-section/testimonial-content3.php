...
<section class="section-module testimonial bg-default testi-3" style="background-image:url('<?php echo esc_url($testimonial_callout_background);?>'); background-repeat: no-repeat; width: 100%; background-size: cover;">
<?php } 
else { ?>
<section class="section-module testimonial bg-default testi-3" >
<?php } 
...
<?php } ?>
	<div class="honeypress-tesi-container container<?php //echo honeypress_container();?>">
		<?php do_action( 'honeypress_homepage_testimonial_title' ); ?>
			<div class="row" <?php if(get_page_template_slug()=="template/template-testimonial-content-7.php"):?>id="testimonial-carousel3"<?php endif;?>>
				<?php if(get_page_template_slug()!="template/template-testimonial-content-7.php"):?>
				...
				<?php
					...
					if( $testimonial_options!='' )
					{
						...
						{ 
							...
							?>
							<div <?php if(get_page_template_slug()=="template/template-testimonial-content-7.php") { ?>class="col-lg-6 col-md-6 col-sm-12"<?php } else { ?> class="item" <?php } ?>>
