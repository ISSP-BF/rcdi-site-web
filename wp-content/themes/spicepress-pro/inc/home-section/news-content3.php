<?php
if (get_theme_mod('spicepress_homeblog_layout', 4) == 4) {
    $masonry_id = 2;
} elseif (get_theme_mod('spicepress_homeblog_layout', 4) == 6) {
    $masonry_id = '';
} elseif (get_theme_mod('spicepress_homeblog_layout', 4) == 3) {
    $masonry_id = 3;
}
?>
<!-- Latest News section -->
<section class="blog-section home-news ">
    <div class="container<?php echo spicepress_container();?>">
        ...
        <div class="row" id="blog-masonry<?php echo $masonry_id; ?>">
            <?php
            $post_display_count = get_theme_mod('spicepress_post_display_count', 3);
