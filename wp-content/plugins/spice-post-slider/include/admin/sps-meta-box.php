    ...
    <table class="sps-tbl">
      <tr>
        ...
        <td class="sps-td-attr">
          <input class="sps-td-post-type" <?php if ($sps_slider_type=='banner_slider') echo "checked";?> type="radio" name="sps_slider_type" value="banner_slider"><label><?php esc_html_e('Banner Slider','spice-post-slider');?></label>&nbsp;&nbsp;
          <input class="sps-td-post-type" <?php if ($sps_slider_type=='blog_post_slider') echo "checked";?> type="radio" name="sps_slider_type" value="blog_post_slider"><label><?php esc_html_e('Blog Post Slider','spice-post-slider');?></label>
        </td>
      </tr>
      ...
      <tr id="sps-banner-layout" <?php if($sps_slider_type=='blog_post_slider') echo 'class="sps-blog-post-slider"';?>>
        ...
        <td class="sps-post-design">
           ...
           if(!empty($sps_banner_design)) 
            ...
            for($i=1;$i<=11;$i++){ 
              ?>
              <div class="sps-design-select" id="sps-pro-banner-badge-<?php echo esc_attr($i);?>"> 
                ...
                <div class="">
                  <div class="sps_admin_showcase">
                     <?php if($i!=1):?><a style="color:#fff;text-decoration:none" target="_blank" href="https://plugin-demo.spicethemes.com/spice-slider-pro/banner-slider/#design-<?php echo esc_attr($i);?>"><div class="ribbon-pro">
      ...
      <tr id="sps-post-layout" <?php if($sps_slider_type=='banner_slider') echo 'class="sps-banner-slider"';?>>
        <td class="sps-td-title"><?php echo esc_html__('Design/Layout','spice-post-slider');?>
        <span class="sps-td-span"><?php echo esc_html__('Choose your favourite design','spice-post-slider');?></span></td>
        <td class="sps-post-design">
           <?php
      ...
      <tr id="sps-post-item-tr" <?php if($sps_slider_type=='banner_slider')echo 'class="sps-banner-slider"';?>>
...
jQuery(document).ready(function(){
    jQuery('input[name="sps_slider_type"]:radio').change(function () {
        var demovalue =jQuery("input[name='sps_slider_type']:checked").val();
        if(demovalue == 'blog_post_slider'){
