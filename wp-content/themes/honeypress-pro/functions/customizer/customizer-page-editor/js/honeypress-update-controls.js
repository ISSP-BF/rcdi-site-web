					...
					$.ajax(
						{
							...
							success: function (result) {
								...
								if (result !== '' && result !== 'undefined' ) {
									...
									jQuery( '#honeypress_page_editor' ).val( content );
									WPEditorWidget.setEditorContent( 'honeypress_page_editor' );
									...
									if (result.post_thumbnail !== '' && result.post_thumbnail !== 'undefined') {
										...
										var html = '<label for="honeypress_feature_thumbnail-button">' +
										...
										'<button type="button" class="button upload-button control-focus" id="honeypress_feature_thumbnail-button">Change Image</button> ' +
