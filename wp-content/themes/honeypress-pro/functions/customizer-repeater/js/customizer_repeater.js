...
function customizer_repeater_refresh_general_control_values() {
    ...
    jQuery('.customizer-repeater-general-control-repeater').each(function () {
        ...
        th.find('.customizer-repeater-general-control-repeater-container').each(function () {
            ...
            var home_slider_caption = jQuery(this).find('.customizer-repeater-slide-caption-align').val();
            ...
            var abtbutton_text = jQuery(this).find('.customizer-repeater-abtbutton-text-control').val();
            var abtlink = jQuery(this).find('.customizer-repeater-abtlink-control').val();
            var abtopen_new_tab = jQuery(this).find('.customizer-repeater-abtcheckbox').attr("checked") ? 'yes' : 'no';
            var sidebar_check = jQuery(this).find('.customizer-repeater-sidebarcheckbox').attr("checked") ? 'yes' : 'no';
    ...
    if (text !== '' || image_url !== '' || title !== '' || subtitle !== '' || icon_value !== '' || link !== '' || designation !== '' || open_new_tab !== '' || choice !== '' || social_repeater !== '' || shortcode !== '' || color !== '' || button_text !== '' || slide_format !== '' || video_url !== '' || price !== '' || features !== '' || price_heighlight !=='' || abtbutton_text !=='' || abtlink !=='' || abtopen_new_tab !=='' || sidebar_check !=='' || home_slider_caption !=='') {
                values.push({
                    ...
                    'abtbutton_text' : abtbutton_text,
                    'abtlink' : abtlink,
                    'abtopen_new_tab' : abtopen_new_tab,
                    'sidebar_check' : sidebar_check,
                    'home_slider_caption' :home_slider_caption,
...
jQuery(document).ready(function () {
    ...
    theme_conrols.on('change','.customizer-repeater-slide-caption-align', function(){
        customizer_repeater_refresh_general_control_values();
        return false;
    ...
    theme_conrols.on('click', '.customizer-repeater-new-field', function () {
        ...
        {
        if(jQuery('#exist_honeypress_Service').val()>=3)
        {
        ...
        return false;   
         ...
         if(jQuery('#exist_honeypress_Service').val()<3)
        {
         var new_service_add_val=parseInt(jQuery('#exist_honeypress_Service').val())+1;
         jQuery('#exist_honeypress_Service').val(new_service_add_val);  
        }
        }
        
        if(split_add_more_button_split=="Add new Test")
        {
        if(jQuery('#exist_honeypress_Testimonial').val()>=3)
        {
        ...
        return false;   
         ...
         if(jQuery('#exist_honeypress_Testimonial').val()<3)
        {
         var new_service_add_val=parseInt(jQuery('#exist_honeypress_Testimonial').val())+1;
         jQuery('#exist_honeypress_Testimonial').val(new_service_add_val);  
        }
        }

        if(split_add_more_button_split=="Add new Team")
        {
        if(jQuery('#exist_honeypress_Team_Member').val()>=4)
        {
        ...
        return false;   
         ...
         if(jQuery('#exist_honeypress_Team_Member').val()<4)
        {
         var new_service_add_val=parseInt(jQuery('#exist_honeypress_Team_Member').val())+1;
         jQuery('#exist_honeypress_Team_Member').val(new_service_add_val);  
        }
        }
        if (typeof th !== 'undefined') {
            ...
            if (typeof field !== 'undefined') {
                ...
                field.find('.customizer-repeater-abtbutton-text-control').val('');
                ...
                field.find('.customizer-repeater-slide-caption-align').val('customizer_repeater_slide_caption_left');
                ...
                field.find('.customizer-repeater-abtlink-control').val('');
                /*Set box id*/
                ...
                field.find('.customizer-repeater-abtcheckbox').val('');
                field.find('.customizer-repeater-sidebarcheckbox').val('');
                /*Append new box*/
    ...
    /**
     * This adds a new box to repeater
     * This will work only with honeypress plus plugin
     */
    ...
    theme_conrols.on('click', '.social-repeater-general-control-remove-field', function () {
        ...
        if (typeof    jQuery(this).parent() !== 'undefined') {
            jQuery(this).parent().hide(500, function(){
                ...
                {
                jQuery('#exist_honeypress_Service').val(parseInt(jQuery('#exist_honeypress_Service').val())-1);  
                }

                if(split_delete_button_split=="Delete Testi")
                {
                jQuery('#exist_honeypress_Testimonial').val(parseInt(jQuery('#exist_honeypress_Testimonial').val())-1); 
                }

                if(split_delete_button_split=="Delete Team ")
                {
                jQuery('#exist_honeypress_Team_Member').val(parseInt(jQuery('#exist_honeypress_Team_Member').val())-1); 
                }
    ...
    theme_conrols.on('keyup','.customizer-repeater-button-text-control', function(){
     ...
     theme_conrols.on('keyup','.customizer-repeater-abtbutton-text-control', function(){
    ...
    theme_conrols.on('keyup', '.customizer-repeater-abtlink-control', function () {
        customizer_repeater_refresh_general_control_values();
    });
   ...
   theme_conrols.on('click', '.customizer-repeater-checkbox', function (event) {
      ...
      theme_conrols.on('click', '.customizer-repeater-abtcheckbox', function (event) {
      if (this.checked) {
          this.setAttribute("checked", "checked");
      } else {
          this.removeAttribute("checked");
      ...
      theme_conrols.on('click', '.customizer-repeater-sidebarcheckbox', function (event) {
      if (this.checked) {
          this.setAttribute("checked", "checked");
      } else {
          this.removeAttribute("checked");
    ...
    theme_conrols.on('change','.customizer-repeater-abtcheckbox', function(){
        
        customizer_repeater_refresh_general_control_values();
    });
     theme_conrols.on('change','.customizer-repeater-sidebarcheckbox', function(){
