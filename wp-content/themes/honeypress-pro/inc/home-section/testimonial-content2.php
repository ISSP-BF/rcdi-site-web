...
<section class="section-module testimonial bg-default" style="background-image:url('<?php echo esc_url($testimonial_callout_background);?>'); background-repeat: no-repeat; width: 100%; background-size: cover;">
<?php } 
else { ?>
...
<?php } ?>
	<div class="honeypress-tesi-container container<?php //echo honeypress_container();?>">		
		...
		<div class="row" <?php if(get_page_template_slug()=="template/template-testimonial-content-6.php"):?>id="testimonial-carousel2" <?php endif;?>>
			<?php if(get_page_template_slug()!="template/template-testimonial-content-6.php"):?>
			...
			if( $testimonial_options!='' )
			{
				...
				{ 
					...
					<div <?php if(get_page_template_slug()=="template/template-testimonial-content-6.php") { ?>class="col-lg-6 col-md-6 col-sm-12"<?php } else { ?> class="item" <?php } ?>>
