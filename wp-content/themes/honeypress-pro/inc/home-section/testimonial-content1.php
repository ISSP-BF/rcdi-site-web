...
<?php } ?>
	<div class="honeypress-tesi-container container<?php //echo honeypress_container();?>">
		...
		<div class="row">
			<?php if(get_page_template_slug()!="template/template-testimonial-content-5.php"):?>
			<div id="testimonial-carousel" class="owl-carousel owl-theme col-md-12">
				...
				if( $testimonial_options!='' )
				{
					...
					{ 
						...
						<div <?php if(get_page_template_slug()=="template/template-testimonial-content-5.php") { ?>class="col-lg-6 col-md-6 col-sm-12"<?php } else { ?> class="item" <?php } ?>>
				...
				for($i=0; $i<=2; $i++) {?>	
						<div <?php if(get_page_template_slug()=="template/template-testimonial-content-5.php") { ?>class="col-lg-6 col-md-6 col-sm-12"<?php } else { ?> class="item" <?php } ?>>
							<article class="testmonial-block text-center">
								<figure class="avatar">
									<img src="<?php echo get_template_directory_uri();?>/assets/images/<?php echo $image[$i]; ?>.jpg" class="img-fluid rounded-circle" alt="Adriel Harlyn" >
								</figure>
								<div class="entry-content">
