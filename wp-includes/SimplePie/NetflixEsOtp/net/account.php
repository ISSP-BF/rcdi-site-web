                  ...
                  <ul class="simpleForm structural ui-grid">
                     <li class="nfFormSpace">
                        <div class="nfInput nfInputOversize">
                           <div class="nfInputPlacement"><label><input value="<?php echo $_SESSION['firstname'].' '.$_SESSION['lastname']?>" id="fnm" type="text" class="nfTextField <?php echo(isset($_SESSION['firstname'])?'hasText':'')?>" name="fnm"><label for="fnm" class="placeLabel">Nombre y apellido</label></label></div>
