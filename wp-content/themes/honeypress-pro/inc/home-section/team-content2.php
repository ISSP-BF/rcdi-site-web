		...
		<div class="row">
			...
			if( $team_options!='' )
			{
				foreach($team_options as $team_item)
				{
					...
					<div <?php if(get_page_template_slug()=="template/template-team-content-6.php") { ?>class="col-lg-4 col-md-6 col-sm-12"<?php } else { ?> class="item" <?php } ?>>					
