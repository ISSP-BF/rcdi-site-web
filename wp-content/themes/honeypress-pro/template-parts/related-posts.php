...
$related_title=get_theme_mod('honeypress_related_post_title',__('Related Posts','honeypress'));
                  ...
                  <?php
                     ...
                     <?php else:?>
                        <a href="<?php the_permalink();?>">
                           <img class='img-fluid'src="<?php echo esc_url(HONEYPRESS_PRO_TEMPLATE_DIR_URI);?>/assets/images/featured/related.png"/>
                        </a>  
                     <?php endif;?>					
               </figure>
