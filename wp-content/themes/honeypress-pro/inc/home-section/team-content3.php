<?php $team_options = get_theme_mod('honeypress_team_content'); 
		...
		<div class="row">
			...
			if( $team_options!='' )
			{
				...
				$image    = ! empty( $team_item->image_url ) ? apply_filters( 'honeypress_translate_single_string', $team_item->image_url, 'Team section' ) : '';
					...
					<div <?php if(get_page_template_slug()=="template/template-team-content-7.php") { ?>class="col-lg-4 col-md-6 col-sm-12 team-grid-format"<?php } else { ?> class="item" <?php } ?>>					
			...
			else
			{
				for($team_id=0; $team_id <=4; $team_id++)
				{
					...
					<div <?php if(get_page_template_slug()=="template/template-team-content-7.php") { ?>class="col-lg-4 col-md-6 col-sm-12"<?php } else { ?> class="item" <?php } ?>>					
					<div class="team-grid text-center">
						<div class="img-holder">
							<img src="<?php echo get_template_directory_uri();?>/assets/images/team/<?php echo $team_img;?>" class="img-fluid" alt="<?php echo $team[$team_img_id];?>">
						</div>
						<figcaption class="details">
			...
			if(get_page_template_slug()!="template/template-team-content-7.php"):			
			?>	
			</div>
		<?php endif; ?>
		</div>	
