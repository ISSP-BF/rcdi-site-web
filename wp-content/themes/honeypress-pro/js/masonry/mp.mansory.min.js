!function(r){r.fn.mpmansory=function(t){var n=r.extend({childrenClass:"",breakpoints:{xl:4,lg:4,md:4,sm:6,xs:12},distributeBy:{attr:"data-order",attrOrder:"asc",order:!1,height:!1},onload:function(r){return!0}},t)
...
a.push(o)}return a},r.fn.distributeItemsByAttr=function(t,n,e){for(var i=0,a=0,s=0;s<n.length;s++)i==t.length&&(i=0),n[s].length>1?(a==n[s].length&&(a=0),t[i].append(r(n[s][a])),a++):t[i].append(r(n[s])),i++},r.fn.apply=function(t,n,e,i){var a=r(this),s=(a.getCurrentColumnSize(),n),o="col-xl-"+t.breakpoints.xl+" col-lg-"+t.breakpoints.lg+" col-md-"+t.breakpoints.md+" col-sm-"+t.breakpoints.sm+"col-xs-"+t.breakpoints.xs+" "+t.columnClasses
