									 ...
									 <?php }  }?>
										...
										<div class="entry-meta">
											<span class="author"><a <?php
                                                    ...
                                                    ?> href="<?php echo esc_url(get_author_posts_url( get_the_author_meta( 'ID' ) ));?>"><?php esc_html_e('Par','honeybee');?> <?php echo esc_html(get_the_author());?></a></span>
										...
										<div class="entry-content">
											<?php the_excerpt();?>
											<p><a href="<?php the_permalink(); ?>" class="more-link"><?php esc_html_e('Lire la suite','honeybee'); ?></a></p>
										</div>	
								</div>			
						</article>					
					<?php
