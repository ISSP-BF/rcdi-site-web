...
<section class="section-module team-mambers team4">
    ...
    <div class="row">
      <?php if(get_page_template_slug()!="template/template-team-content-8.php"):?>
      ...
      if( $team_options!='' )
      {
        ...
        $image    = ! empty( $team_item->image_url ) ? apply_filters( 'honeypress_translate_single_string', $team_item->image_url, 'Team section' ) : '';
          ...
          $open_new_tab = $team_item->open_new_tab; ?>
            <div <?php if(get_page_template_slug()=="template/template-team-content-8.php") { ?>class="col-lg-4 col-md-6 col-sm-12"<?php } else { ?> class="item" <?php } ?>>          
