...
<section class="section-module testimonial bg-default testi-4"  style="background-image:url('<?php echo esc_url($testimonial_callout_background);?>'); background-repeat: no-repeat; width: 100%; background-size: cover;">
<?php } 
else { ?>
<section class="section-module testimonial bg-default testi-4" >
<?php 
} 
...
<?php } ?>
		<div class="honeypress-tesi-container container<?php //echo honeypress_container();?>">
			...
			<div class="row" <?php if(get_page_template_slug()=="template/template-testimonial-content-8.php"):?>id="testimonial-carousel4"<?php endif;?>>
			<?php if(get_page_template_slug()!="template/template-testimonial-content-8.php"):?>
				<div id="testimonial-carousel4" class="owl-carousel owl-theme col-md-12">
				<?php endif;
					...
					if( $testimonial_options!='' )
					{
						...
						{ 
							...
							?>
							<div <?php if(get_page_template_slug()=="template/template-testimonial-content-8.php") { ?>class="col-lg-6 col-md-6 col-sm-12"<?php } else { ?> class="item" <?php } ?>>
								<article class="testmonial-block text-center">
									...
									<?php endif; if( $title != '' || $designation != '') 
									{?>	
					...
					else
					{
						...
						?>
							<div <?php if(get_page_template_slug()=="template/template-testimonial-content-8.php") { ?>class="col-lg-6 col-md-6 col-sm-12"<?php } else { ?> class="item" <?php } ?>>
								<article class="testmonial-block text-center">
									<figure class="avatar">
										<img src="<?php echo get_template_directory_uri();?>/assets/images/<?php echo $image[$i]; ?>.jpg" class="img-fluid rounded-circle" alt="<?php echo $name[$i]; ?>" >
									</figure>
									<figcaption>
