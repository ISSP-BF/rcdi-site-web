...
<div id="sps-about" class="sps-about-page">
	<div class="spice-col-2">
		<div class="sps-about-img">
			<img src="<?php echo SPS_URL.'assets/img/about-mockup.png';?>">
		</div>
		...
		<div class="sps-about-freepro-compare">
			<table>
				...
				<tr>
					...
					<td class="table-td-content"><?php esc_html_e('2','spice-post-slider');?></td>
					<td class="table-td-content"><?php esc_html_e('15+','spice-post-slider');?></td>
				</tr>
				<tr>
