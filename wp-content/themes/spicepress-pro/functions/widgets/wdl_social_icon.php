<?php // Register and load the widget
	function spicepress_social_icon_widget() {
	    register_widget( 'spicepress_social_icon_widget' );
	}
	add_action( 'widgets_init', 'spicepress_social_icon_widget' );

// Creating the widget
	class spicepress_social_icon_widget extends WP_Widget {
	 
	function __construct() {
		parent::__construct(
			'spicepress_social_icon_widget', // Base ID
			__('ST: Social icons','spicepress'), // Widget Name
			array(
				'classname' => 'spicepress_social_icon_widget',
				'description' => __('SpicePress social icons widget','spicepress'),
			),
			array(
				'width' => 300,
			)
	...
	?>
	<!-- Facebook Link -->
	<h4 for="<?php echo $this->get_field_id( 'facebook_link' ); ?>"><?php _e( 'Facebook URL','spicepress' ); ?></h4>
	...
	<label for="<?php echo $this->get_field_id( 'facebook_target' ); ?>"><?php _e( 'Open link in new tab','spicepress' ); ?></label>
	
	<!-- Twitter Link -->
	<h4 for="<?php echo $this->get_field_id( 'twitter_link' ); ?>"><?php _e( 'Twitter URL','spicepress' ); ?></h4>
	...
	<label for="<?php echo $this->get_field_id( 'twitter_target' ); ?>"><?php _e( 'Open link in new tab','spicepress' ); ?></label>
	
	<!-- Lindedin Link -->
	<h4 for="<?php echo $this->get_field_id( 'linkedin_link' ); ?>"><?php _e( 'LinkedIn URL','spicepress' ); ?></h4>
	...
	<label for="<?php echo $this->get_field_id( 'linkedin_target' ); ?>"><?php _e( 'Open link in new tab','spicepress' ); ?></label>
	
	<!-- Instagram Link -->
	<h4 for="<?php echo $this->get_field_id( 'instagram_link' ); ?>"><?php _e( 'Instagram URL','spicepress' ); ?></h4>
	...
	<label for="<?php echo $this->get_field_id( 'instagram_target' ); ?>"><?php _e( 'Open link in new tab','spicepress' ); ?></label>
	
	<!-- Youtube Link -->
	<h4 for="<?php echo $this->get_field_id( 'youtube_link' ); ?>"><?php _e( 'Youtube URL','spicepress' ); ?></h4>
	...
	<label for="<?php echo $this->get_field_id( 'youtube_target' ); ?>"><?php _e( 'Open link in new tab','spicepress' ); ?></label>
	
	<!-- Skype Link -->
	<h4 for="<?php echo $this->get_field_id( 'skype_link' ); ?>"><?php _e( 'Skype URL','spicepress' ); ?></h4>
	...
	<label for="<?php echo $this->get_field_id( 'skype_target' ); ?>"><?php _e( 'Open link in new tab','spicepress' ); ?></label>
	
	<!-- Vimeo Link -->
	<h4 for="<?php echo $this->get_field_id( 'vimeo_link' ); ?>"><?php _e( 'Vimeo URL','spicepress' ); ?></h4>
	...
	<label for="<?php echo $this->get_field_id( 'vimeo_target' ); ?>"><?php _e( 'Open link in new tab','spicepress' ); ?></label>
	
	<!-- Dribble Link -->
	<h4 for="<?php echo $this->get_field_id( 'dribble_link' ); ?>"><?php _e( 'Dribble URL','spicepress' ); ?></h4>
	...
	<label for="<?php echo $this->get_field_id( 'dribble_target' ); ?>"><?php _e( 'Open link in new tab','spicepress' ); ?></label>
