...
<article class="post">
	...
	if(get_post_format()=="link")
		{
			$masonry_display=honeypress_print_post_audio();
		}
	elseif (get_post_format()=="gallery") 
		{
			$masonry_display=honeypress_print_gallery_slider( $gallery_mode, $slider_items, $image_size_slider  );	
		}
	elseif (get_post_format()=="video")
		{
			$masonry_display=honeypress_print_post_video( 'single-post' );	
		}
	elseif (get_post_format()=="quote") 
		{
			$masonry_display=	the_post_thumbnail('full',array('class'=>'img-fluid'));
		}
	elseif (get_post_format()=="audio") 
		...
		?>
			...
			<?php $masonry_display=the_post_thumbnail('full',array('class'=>'img-fluid')); ?>
			</a>
	<?php	
		}
	?>				
	...
	if(get_theme_mod('honeypress_enable_blog_category',true)==true):
		...
		<header class="entry-header">
			<h2 class="entry-title blog-masonry-four-col"><a href="<?php the_permalink();?>"><?php the_title();?></a></h2>
		</header>	
