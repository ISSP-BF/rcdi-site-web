...
<section class="masonry section-module blog grid-view <?php if($exc_length!='excerpt') { echo 'twomasonary-full-width'; }?>">
	<div class="container<?php echo honeypress_blog_post_container();?>">
		...
		<div class="grid">
			...
			if($loop->have_posts()): 
				...
				get_template_part('template-parts/ajax-masonary-content');
				endwhile;
			endif;	?>
		</div>
